...
\begin{equation*}
	\begin{aligned}
		F & = \iiint_V g(x,y,z) \, dV                                                                                                  \\
		  ...
		  & \approx \boxed{374,649,962,215,039.5000} \label{eq:stu4q1}
	\end{aligned}
\end{equation*}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.95\textwidth]{figures/stu4q1.png}
	\end{center}
...
The manual calculation for the total muscle force (Equation \ref{eq:stu4q1}) gives the \textbf{same} result as the MATLAB script (Figure \ref{fig:stu4q1}).
